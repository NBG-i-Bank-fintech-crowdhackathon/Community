...
namespace CrowdHacakthon
{
    ...
    /// </summary>
    public sealed partial class MainUserPage : Page
    {
        public MainUserPage()
        {
        ...
        {
            (Application.Current as App).UserSendRequest((Application.Current as App).BusinessId,"i0001",10, (Application.Current as App).UserId);
        }
